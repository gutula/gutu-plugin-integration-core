...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/integration-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-integration-core:");
...
console.log("Documentation check passed for gutu-plugin-integration-core.");
